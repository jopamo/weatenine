...
function App({ setCurrentPage }) {
  ...
  const startPainting = () => {
    ...
    requestAnimationFrame(() => {
      ...
      if (colorsTable) {
        const scrollPosition = colorsTable.getBoundingClientRect().top + window.pageYOffset;
    ...
    <div className="control-panel">
      <form onSubmit={handleSubmit} className="settings-form">
        <div className="buttons-container">
          <button onClick={startPainting} disabled={dimensions.xDimension === 0 || dimensions.yDimension === 0}>
            Start Painting
          </button>
        ...
        <div className="form-row">
          <div className="form-group">
            ...
            <input
              ...
              onChange={(e) => setDimensions(prev => ({ ...prev, xDimension: Number(e.target.value) }))}
              disabled={isPainting}
              maxLength="2" />
          </div>
          <div className="form-group">
            ...
            <input
              ...
              onChange={(e) => setDimensions(prev => ({ ...prev, yDimension: Number(e.target.value) }))}
              disabled={isPainting}
              maxLength="2" />
          </div>
        </div>
